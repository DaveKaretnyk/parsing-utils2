...
import Grammar.Gen.Python27BaseListener;
import Grammar.Gen.Python27Lexer;
import Grammar.Gen.Python27Parser;


/** Analyze Python files (modules) according to the Python27.g4 grammar. */
public class CheckGrammar {
    ...
    private Python27BaseListener listener;
    // Information to stdout?
    private boolean stdout;

    /** Analyze the list of modules using the Python27.g4 grammar.
